...
import { FaUser, FaLock, FaEdit, FaEye, FaEyeSlash, FaUserShield } from "react-icons/fa";
    ...
    return (
      <div className="pr-10 bg-gray-50 min-h-screen pb-10">
        <div className="border-b-2 border-gray-200 pb-2 mb-6 pt-3">
          <h1 className="text-heading text-[21px] font-semibold">Super Admin Profile</h1>
        </div>
  ...
  return (
    <div className="pr-10 bg-gray-50 min-h-screen pb-10">
      ...
      <div className="max-w-2xl mx-auto">
        {/* Profile Header Card */}
        <div className="bg-gradient-to-r bg-gradient-primary rounded-lg shadow-lg p-8 mb-6">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="w-32 h-32 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center border-4 border-white shadow-lg mb-4">
              <FaUserShield size={60} className="text-white" />
            </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-primary pb-2 border-b-2 border-purple-100">
              Profile Information
            </h3>
            <button
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-3">
              <FaUserShield className="text-primary mt-1 flex-shrink-0" size={20} />
              <div className="flex-1">
        ...
        <div className="mt-6 bg-purple-50 border border-purple-200 rounded-lg p-4">
          <p className="text-sm text-purple-800">
            <strong>Super Admin Access:</strong> As a super administrator, you have full system access. 
            ...
            <form onSubmit={handleCredentialsSubmit} className="space-y-4">
              ...
              <div className="flex justify-end space-x-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={updatingCredentials}
                  className="px-4 py-2 bg-primary text-white rounded-md hover:bg-purple-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                >
                  {updatingCredentials ? (
                    <>
